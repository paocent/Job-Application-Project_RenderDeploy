...
A full‑stack **Job Application Tracker** that helps you log, manage, and organize your job applications with deploy support via **Render**. Track application details like company, role, status, dates, and notes all in one place, and easily see where you stand in your job search process.  
